...
const Schedule = () => {
  ...
  <table className="waffle text-base" cellSpacing="0" cellPadding="0">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr  >
        ...
        <td className="s2" dir="ltr">🍽️ Dinner<br />🔥 Music / Performances by the fire<br />🍡 Smore’sgasburg – sweet and
          savory smores</td>
        <td className="s2" dir="ltr">Lodge<br />Firepit</td>
      </tr>
      <tr  >
      ...
      <tr  >
        ...
        <td className="s2" dir="ltr">Lodge</td>
      </tr>
      <tr  >
      ...
      <tr  >
        ...
        <td className="s4" dir="ltr">🍽️ Dinner <br />🎸 Music and lightweight visual showcase on the lake (rain location
          lodge)</td>
        <td className="s2" dir="ltr">Lake<br />Lodge</td>
      </tr>
      <tr  >
      ...
      <tr  >
        ...
        <td className="s3" dir="ltr">🍽️ Sandwich lunch<br />🐟 Swimming<br />🌸 Botanical print day 2<br />🤡 Puppet making<br />🎨
          TBD activities<br />🤹‍♀️ Weekend showcase</td>
        <td className="s3"></td>
      </tr>
      <tr  >
